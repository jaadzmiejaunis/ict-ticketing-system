<x-app-layout>
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm sm:rounded-lg p-6 transition-colors">
                ...
                <div class="
                    ...
                    [&_.fc-toolbar-title]:text-gray-900 dark:[&_.fc-toolbar-title]:text-white [&_.fc-toolbar-title]:font-bold
                    ...
                    [&_.fc-col-header-cell-cushion]:text-gray-600 dark:[&_.fc-col-header-cell-cushion]:text-gray-300 [&_.fc-col-header-cell-cushion]:py-2
                    ...
                    [&_.fc-list-empty]:bg-white dark:[&_.fc-list-empty]:bg-gray-800
                    [&_.fc-list]:border-gray-200 dark:[&_.fc-list]:border-gray-700
                    [&_.fc-list-day-cushion]:bg-gray-50 dark:[&_.fc-list-day-cushion]:bg-gray-700
                    ...
                    [&_.fc-more-link]:text-indigo-600 dark:[&_.fc-more-link]:text-indigo-400 [&_.fc-more-link]:font-bold
